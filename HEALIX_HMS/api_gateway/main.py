...
SERVICES = {
    ...
    "billing": os.getenv("BILLING_SERVICE_URL", "http://localhost:8005"),
    "pharmacy": os.getenv("PHARMACY_SERVICE_URL", "http://localhost:8006"),
    "lab": os.getenv("LAB_SERVICE_URL", "http://localhost:8007"),
    "ward": os.getenv("WARD_SERVICE_URL", "http://localhost:8008"),
    "emergency": os.getenv("EMERGENCY_SERVICE_URL", "http://localhost:8009"),
    "ambulance": os.getenv("AMBULANCE_SERVICE_URL", "http://localhost:8010"),
    "hr": os.getenv("HR_SERVICE_URL", "http://localhost:8011"),
    "maintenance": os.getenv("MAINTENANCE_SERVICE_URL", "http://localhost:8012"),
    "radiology": os.getenv("RADIOLOGY_SERVICE_URL", "http://localhost:8013"),
    "notification": os.getenv("NOTIFICATION_SERVICE_URL", "http://localhost:8014"),
    "analytics": os.getenv("ANALYTICS_SERVICE_URL", "http://localhost:8015"),
}

...
import { User, Lock, Mail, ShieldCheck, Building, Phone } from 'lucide-react';
    ...
    return (
        <DashboardLayout role="receptionist">
            <SectionHeader
                ...
                subtitle="Manage your identity credentials and hub access"
            />
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: '3rem' }}>
                <div className="glass-v3" style={{ textAlign: 'center', padding: '3rem 2rem' }}>
                    ...
                    <h3 style={{ fontSize: '1.6rem', fontWeight: 950, margin: 0, color: '#0f172a' }}>{profile?.full_name || user.username}</h3>
                    <p style={{ color: '#64748b', fontSize: '0.9rem', fontWeight: 800, marginBottom: '2.5rem', textTransform: 'uppercase', letterSpacing: '1px' }}>Front Desk Executive</p>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', textAlign: 'left' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', padding: '1.2rem', background: '#f8fafc', borderRadius: '18px', border: '1px solid #f1f5f9' }}>
                            ...
                            <span style={{ fontSize: '0.85rem', fontWeight: 700 }}>Central Reception Hub</span>
                        </div>
                    </div>
                </div>

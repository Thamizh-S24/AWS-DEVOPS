...
import { Bell, Shield, User, Group, Trash2, Maximize2 } from 'lucide-react';
...
const ReceptionistNotifications = () => {
    ...
    useEffect(() => {
        ...
        // Note: Using window.location.hostname for consistency
    ...
    return (
        <DashboardLayout role="receptionist">
            <SectionHeader
                title="Reception Intelligence Feed"
                subtitle="Real-time operational alerts and system broadcasts"
            />
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
                    ...
                    {notifications.length === 0 && !loading && (
                        <div style={{ padding: '6rem', textAlign: 'center', color: '#94a3b8' }}>
                            ...
                            <p style={{ marginTop: '0.5rem', fontSize: '0.9rem', fontWeight: 500 }}>No system broadcasts received</p>
                        </div>
                    )}
                </div>
            </div>
